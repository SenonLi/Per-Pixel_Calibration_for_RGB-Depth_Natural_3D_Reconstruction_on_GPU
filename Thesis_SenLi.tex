...
\usepackage[pdfauthor={Sen Li},
            pdftitle={Per-Pixel Calibration for RGB-Depth Natural 3D Reconstruction on GPU},
...
\author{Sen Li}
\title{Per-Pixel Calibration for RGB-Depth Natural \gls{3D} Reconstruction on \gls{GPU}}
\abstract{%
...
\singlespacing
\printglossary[title={Appendix:      List of Symbols}]%, toctitle={List of Symbols}]
\addcontentsline{toc}{chapter}{Appendix: List of Symbols}
